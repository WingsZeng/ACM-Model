...
\subsection{Dinic}
\cpp{codes/graph/dinic.cpp}

\subsection[费用流]{费用流EK算法}
\cpp{codes/graph/ek-mcmf.cpp}
...
\inputminted[linenos,breaklines,tabsize=4,mathescape,texcl]{bat}{codes/windows-check.bat}

\subsubsection{Linux}
\inputminted[linenos,breaklines,tabsize=4,mathescape,texcl]{sh}{codes/linux-check.sh}
